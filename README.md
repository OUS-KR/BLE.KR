...
- `BLE.KR/u/{사용자 아이디}` 주소 기반의 사용자 등록
  - 사용자 예제: [BLE.KR/u/ble](https://ble.kr/u/ble), [BLE.KR/u/tests/](https://ble.kr/u/tests)
  - [사용자 등록 예제](https://github.com/OUS-KR/BLE.KR/issues/1)
- `BLE.KR/@{사용자 아이디}` 형태의 짧은 주소 지원
  - 사용자 예제: [BLE.KR/@ble](https://ble.kr/@ble), [BLE.KR/@tests](https://ble.kr/@tests)
...
- `BLE.KR/u/{사용자 아이디}/{글 경로}` 형태의 글 작성
  - 마크다운 문법: [마크다운 문법](https://github.com/OUS-KR/BLE.KR?tab=readme-ov-file#%EB%A7%88%ED%81%AC%EB%8B%A4%EC%9A%B4-%EB%AC%B8%EB%B2%95-%EC%98%88%EC%8B%9C), [마크다운 문법 예제](https://ble.kr/@ble/articles/md_example)
...
- 유튜브 영상: `BLE.KR/yt/{유튜브 영상 아이디}`
  - 예제: [BLE.KR/yt/1ZX1vEDTfY4](https://ble.kr/yt/1ZX1vEDTfY4), [BLE.KR/yt/yebNIHKAC4A](https://ble.kr/yt/yebNIHKAC4A)
- 유튜브 영상 + 시작 시간 옵션: `BLE.KR/{유튜브 영상 아이디}/{시작 시간}`
...
- 유튜브 영상 썸네일 링크: `[![{유튜브 영상 썸네일 텍스트}]({유튜브 영상 썸네일 주소})]({유튜브 영상 주소})`
  - 예제: `[![FIFTY FIFTY (피프티피프티) 'Pookie' Official MV](https://BLE.KR/yt/img/1ZX1vEDTfY4)](https://BLE.KR/yt/1ZX1vEDTfY4/1m6s)`
  [![FIFTY FIFTY (피프티피프티) 'Pookie' Official MV](https://BLE.KR/yt/img/1ZX1vEDTfY4)](https://BLE.KR/yt/1ZX1vEDTfY4/1m6s)
  - 예제: `[![“Golden” Official Lyric Video | KPop Demon Hunters | Sony Animation](https://BLE.KR/yt/img/yebNIHKAC4A)](https://BLE.KR/yt/yebNIHKAC4A/56)`
  [![“Golden” Official Lyric Video | KPop Demon Hunters | Sony Animation](https://BLE.KR/yt/img/yebNIHKAC4A)](https://BLE.KR/yt/yebNIHKAC4A/56)
...
[마크다운 문법 예제](https://ble.kr/@ble/articles/md_example)
